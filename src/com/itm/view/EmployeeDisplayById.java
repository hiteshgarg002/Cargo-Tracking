...
public class EmployeeDisplayById extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<input type=hidden value='"+E.getId()+"' name=cid>");
        out.println("<tr>");
        out.println("<td><b><i>Employee Name:</i></b></td><td><input type=text name=employeename value='"+E.getEmployee_name()+"' size=30></td>");
        out.println("</tr>");
        ...
        out.println("<tr>");
        out.println("<td><b><i>Phone No:</i></b></td><td><input type=text name=phoneno  value='"+E.getPhone_no()+"' size=30></td>");
        out.println("</tr>");
    
        out.println("<tr>");
        out.println("<td><b><i>Mobile No:</i></b></td><td><input type=text name=mobileno  value='"+E.getMobile_no()+"' size=30></td>");
        out.println("</tr>");
        ...
        out.println("<img src=images/"+E.getPhoto()+" width=250 height=250><br><br><b><i>Update Picture:<i><br><input type=file name=photograph><br><br><input type=submit name=btn value=Update></td></tr></table>");
